...
api.nnoremap("<C-LeftMouse", ":call vm#commands#add_cursor_at_pos(0)<cr>")

-- select all occurrences
api.nnoremap("<C-d>", ":call vm#commands#find_all(0, 1)<cr>")
api.inoremap("<C-d>", ":call vm#commands#find_all(0, 1)<cr>")
